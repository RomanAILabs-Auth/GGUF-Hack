...
logger.info("="*80)
logger.info("RomanAILabs GGUF Editor")
logger.info("Contact: romanailabs@gmail.com")
logger.info("="*80)
...
class GGUFEditorApp:
    ...
    def setup_window(self):
        ...
        self.root.title("RomanAILabs GGUF Editor")
    ...
    def setup_ui(self):
        ...
        email_label.pack(side="left", padx=(0, 20), pady=20)
    ...
    def show_debug_window(self, error_details: str):
        ...
        debug_window.title("🐛 Debug Information - RomanAILabs GGUF Editor")
        ...
        title_label = tk.Label(
            debug_window,
            text="🐛 Error Debug Information - RomanAILabs GGUF Editor",
        ...
        # Email contact in debug window
        email_label = tk.Label(
            debug_window,
            text="Contact: romanailabs@gmail.com",
            font=("Segoe UI", 10),
            bg=ModernColors.BG_PRIMARY,
            fg=ModernColors.FG_SECONDARY,
            cursor="hand2"
...
"""
    ...
    def _open_email(self):
        ...
        import webbrowser
        try:
            webbrowser.open(f"mailto:romanailabs@gmail.com")
        except Exception:
            # Fallback: copy to clipboard
            try:
                self.root.clipboard_clear()
                self.root.clipboard_append("romanailabs@gmail.com")
                messagebox.showinfo("Email", "Email address copied to clipboard:\nromanailabs@gmail.com")
            except Exception:
                messagebox.showinfo("Contact", "Email: romanailabs@gmail.com")
